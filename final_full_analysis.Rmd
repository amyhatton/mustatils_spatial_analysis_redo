...
```{r rhohat plots}
pdf("plots/rhohat/analysis_redo/all_rhohats_long.pdf", width= 7, height=10.5)
par(mfrow = c(3,2))
...
pdf("plots/rhohat/analysis_redo/variable_maps.pdf", width=14, height=5)
par(mfrow = c(2,3))
plot(tpi_stack$tpi_3, main="TPI 90m", col=pal(12), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
plot(tpi_stack$tpi_5, main="TPI 150m", col=pal(12), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
plot(tri_stack$tri_5, main="TRI 150m", col=viridis(10), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
plot(tri_stack$tri_15, main="TRI 450m", col=viridis(10), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
...
plot(dist_pekel_water, main="Dist to recent water occurence", col=plasma(20), axes=FALSE, box=FALSE, legend.args=list(text="",side=2), horizontal=TRUE )
plot(dist_sandstone_geo, main="Dist sandstone", col=plasma(20), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
plot(dist_non_quart_geo, main="Dist non-quarternary geo", col=plasma(20), axes=FALSE, box=FALSE, legend.args=list(text="",side=2))
