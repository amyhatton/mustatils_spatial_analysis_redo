...
#standardise the variables to see if it helps with collinearity - didn't work
#rs <- list(r1)
#for (i in 1:length(rresamp)){
  #rs[[i]] <- terra::scale(rresamp[[i]], scale = T)
#}
...
Instead of assuming multicollinearity is an issue I have decided to rather test this later on in the process
...
##remove tri 3##
c_trend <- ~slope_im + tpi_3_im + tpi_5_im + tri_5_im + tri_15_im + rough_3_im + rough_5_im + rough_15_im +dem_im + dist_rivers_im + dist_sandstone_geo_im + dist_non_quart_geo_im + viewshed_im + eastness_im + pekel_im
...
##remove roughness 3##
c_trend <- ~slope_im + tpi_3_im + tpi_5_im + tri_5_im + tri_15_im  + rough_5_im + rough_15_im +dem_im + dist_rivers_im + dist_sandstone_geo_im + dist_non_quart_geo_im + viewshed_im + eastness_im + pekel_im
...
##remove roughness 5##
c_trend <- ~slope_im + tpi_3_im + tpi_5_im + tri_5_im + tri_15_im + rough_15_im +dem_im + dist_rivers_im + dist_sandstone_geo_im + dist_non_quart_geo_im + viewshed_im + eastness_im + pekel_im
...
##remove roughness 15##
c_trend <- ~slope_im + tpi_3_im + tpi_5_im + tri_5_im + tri_15_im +dem_im + dist_rivers_im + dist_sandstone_geo_im + dist_non_quart_geo_im + viewshed_im + eastness_im + pekel_im
...
dev.off()
#worked but its not helpful- need to normalise go back to manual method
